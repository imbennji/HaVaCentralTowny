...
public class TownyadminExtraspawnplayerExecutor implements CommandExecutor
{
	public static void create(CommandSpec.Builder cmd) {
		cmd.child(CommandSpec.builder()
				.description(Text.of(""))
				.permission("towny.command.townyadmin.extraspawnplayer")
				.arguments(
				...
				.executor(new TownyadminExtraspawnplayerExecutor())
