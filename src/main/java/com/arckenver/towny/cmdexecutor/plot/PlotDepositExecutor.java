...
import com.arckenver.towny.cmdexecutor.townyadmin.TownyadminCollectRentExecutor;
...
public class PlotDepositExecutor implements CommandExecutor {

	public static void create(CommandSpec.Builder cmd) {
		cmd.child(CommandSpec.builder()
				.description(Text.of(""))
				.permission("towny.command.plot.deposit")
				.arguments(GenericArguments.optional(GenericArguments.doubleNum(Text.of("amount"))))
				.executor(new PlotDepositExecutor())
				.build(), "deposit");
	}
