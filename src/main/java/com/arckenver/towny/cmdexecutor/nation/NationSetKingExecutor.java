...
public class NationSetKingExecutor implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException {
        ...
        if (!ctx.<String>getOne("player").isPresent()) {
            src.sendMessage(Text.of(LanguageHandler.colorYellow(), "/nation setking <player>"));
            return CommandResult.success();
        }
        ...
        src.sendMessage(Text.of(LanguageHandler.colorGreen(), LanguageHandler.INFO_NATION_KING));
        return CommandResult.success();
    }
}
