...
public class NationWithdrawExecutor implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException {
        ...
        if (!ctx.<Double>getOne("amount").isPresent()) {
            src.sendMessage(Text.of(LanguageHandler.colorYellow(), "/nation withdraw <amount>"));
            return CommandResult.success();
        }
        ...
        if (result.getResult() == ResultType.ACCOUNT_NO_FUNDS) {
            src.sendMessage(Text.of(LanguageHandler.colorRed(), LanguageHandler.ERROR_NATION_BANK_FUNDS));
            return CommandResult.success();
