...
public class LanguageHandler
{
	...
	public static String HELP_DESC_CMD_P_PERM = "set plot perm";
        ...
        public static String HELP_DESC_CMD_P_SETTYPE = "set the plot type";
	...
	public static String ERROR_BADWORLDNAME = "Invalid world name";
        ...
        public static String ERROR_PLOT_TYPE_INVALID = "Invalid plot type: {TYPE}";
	...
	public static String ERROR_PLOTINTERSECT = "There is a plot that intersects with your selection";
        ...
        public static String SUCCESS_PLOT_TYPE_SET = "Plot type set to {TYPE}.";
        public static String ERROR_NOOWNER = "You must own this plot to perform that command";
        public static String ERROR_PLOT_TYPE_FLAG_LOCKED = "The {FLAG} flag is locked for {TYPE} plots.";
        public static String ERROR_PLOT_TYPE_PERM_LOCKED = "The {PERM} permission is locked for {TYPE} plots.";
        public static String ERROR_PLOT_FOREIGN_OWNERSHIP = "Only embassy plots may be owned by non-residents.";
	...
	public static String ERROR_ISBOUGHT = "You have bought this plot, use /plot delowner instead";
        ...
        public static String INFO_PLOT_TYPE_UNCHANGED = "Plot type is already {TYPE}.";
	...
	public static String TOAST_NOPVP = "No PvP";
        ...
        public static String FORMAT_PLOT_TYPE = "Plot Type";
	...
	public static String FORMAT_RENT_PRICE = "Rent";
        ...
        public static String PLOT_TYPE_RESIDENTIAL = "Residential";
        public static String PLOT_TYPE_SHOP = "Shop";
        public static String PLOT_TYPE_EMBASSY = "Embassy";
        public static String PLOT_TYPE_FARM = "Farm";
        public static String PLOT_TYPE_INN = "Inn";
        public static String PLOT_TYPE_JAIL = "Jail";
        public static String PLOT_TYPE_ARENA = "Arena";
        public static String PLOT_TYPE_WILDS = "Wilds";
