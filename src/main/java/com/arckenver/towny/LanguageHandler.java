...
public class LanguageHandler
{
	...
	public static String HELP_DESC_CMD_T_COST = "display town prices";
        ...
        public static String HELP_DESC_CMD_N_TOGGLEPUBLIC = "toggle whether the nation is public";
        public static String HELP_DESC_CMD_N_TOGGLENEUTRAL = "toggle whether the nation is neutral";
        public static String HELP_DESC_CMD_N_SETSPAWN = "set the nation spawn";
        public static String HELP_DESC_CMD_N_SPAWN = "teleport to a nation spawn";
        public static String HELP_DESC_CMD_N_SETCAPITAL = "set the nation capital";
        public static String HELP_DESC_CMD_N_SETKING = "appoint a new nation leader";
        public static String HELP_DESC_CMD_N_RANK = "manage nation assistants";
        public static String HELP_DESC_CMD_N_DEPOSIT = "deposit money into the nation bank";
        public static String HELP_DESC_CMD_N_WITHDRAW = "withdraw money from the nation bank";
        public static String HELP_DESC_CMD_N_TAXES = "configure nation taxes";
        public static String HELP_DESC_CMD_N_ALLY = "manage nation alliances";
        public static String HELP_DESC_CMD_N_ENEMY = "manage nation enemies";
        public static String HELP_DESC_CMD_N_SETSPAWNCOST = "set the cost to use the nation spawn";
	...
	public static String ERROR_NEEDWORLDNAME = "You must specify world name";
        ...
        public static String ERROR_PERM_NATION_CAPITAL = "Only the capital mayor may perform that command";
        ...
        public static String ERROR_NATION_SELF_RELATION = "A nation cannot target itself";
        public static String ERROR_NATION_NO_SPAWN = "This nation has no spawn set";
        public static String ERROR_NATION_SPAWN_PRIVATE = "You may only visit the spawn of a public nation";
        public static String ERROR_NATION_SPAWN_NOT_PUBLIC = "Your nation must be public to allow outsiders to spawn";
        public static String ERROR_NATION_SPAWN_COST = "The spawn cost must be between 0 and {MAX}";
        public static String ERROR_NATION_TAX_RANGE = "Nation taxes must be between 0 and {MAX}";
        public static String ERROR_NATION_BANK = "The nation bank account could not be accessed";
        public static String ERROR_NATION_BANK_PLAYER_FUNDS = "You do not have enough money";
        public static String ERROR_NATION_BANK_FUNDS = "The nation bank does not have enough money";
        ...
        public static String ERROR_NATION_SPAWN_WORLD_DISABLED = "Nations may not set a spawn in this world";
	...
	public static String INFO_RENTTIME = "It's time to pay rent in your town, paying the landlord!";
        ...
        public static String INFO_NATION_ASSISTANT_ADDED = "Nation assistant added";
        public static String INFO_NATION_ASSISTANT_REMOVED = "Nation assistant removed";
        ...
        public static String INFO_NATION_ENEMY_ADDED = "Nation rivalry created";
        public static String INFO_NATION_ENEMY_REMOVED = "Nation rivalry removed";
        ...
        public static String INFO_NATION_TAXES_PERCENT = "Nation tax mode updated";
